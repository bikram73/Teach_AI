...
import { LEARNING_PATH_NODES } from '../data/mockData';
...
export const LearningPathScreen: React.FC<LearningPathScreenProps> = ({ onNavigate }) => {
  return (
      ...
      <div className="flex-1 flex flex-col p-4 md:p-8 max-w-5xl mx-auto w-full pb-20 md:pb-8">
        ...
        <div className="bg-white border border-[#c7c4d7]/60 rounded-3xl p-6 md:p-8 shadow-sm mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-[#464554] mt-1">
              Personalized syllabus generated by Nova based on your skill assessment.
            </p>
          </div>
          ...
          <div className="w-full md:w-64 bg-[#f2f3ff] p-4 rounded-2xl border border-[#c7c4d7]/50">
            <div className="flex justify-between text-xs font-bold mb-1.5">
              ...
              <span className="text-[#4648d4]">45% Complete</span>
            </div>
            <div className="w-full h-3 bg-white rounded-full overflow-hidden border border-[#c7c4d7]/40">
              <div className="h-full bg-gradient-to-r from-[#4648d4] to-[#8B5CF6] rounded-full transition-all duration-700" style={{ width: '45%' }} />
            </div>
            <div className="flex justify-between text-[11px] text-[#464554] mt-2">
              <span>2/5 Modules Mastered</span>
        ...
        <div className="bg-white border border-[#c7c4d7]/60 rounded-3xl p-6 md:p-8 shadow-sm mb-6">
          <div className="flex items-center justify-between mb-8 pb-4 border-b border-[#c7c4d7]/40">
            ...
            <span className="text-xs text-[#464554] font-medium">Auto-adapts after every quiz</span>
          </div>
                  ...
                  <div
                    className={`absolute -left-[37px] md:-left-[45px] top-1 w-9 h-9 md:w-10 md:h-10 rounded-full flex items-center justify-center border-4 border-white shadow-sm transition-transform ${
                      isMastered
                        ...
                        : isInProgress
                        ? 'bg-[#6063ee] text-white ai-glow scale-110'
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
                      <div className="flex items-center gap-2.5">
                        ...
                        <h3 className={`font-bold text-base ${isInProgress ? 'text-[#4648d4]' : 'text-[#131b2e]'}`}>
                          {node.title}
                        </h3>
                      </div>
                      ...
                      {isInProgress && (
                        <span className="inline-flex items-center gap-1 text-[11px] font-bold text-white bg-[#6063ee] px-2.5 py-0.5 rounded-full shadow-sm">
                    ...
                    <p className="text-xs text-[#464554] mb-3">{node.dateOrInfo}</p>
                    ...
                    {isInProgress && (
                      <div className="flex items-center justify-between pt-2 border-t border-[#4648d4]/20">
                        ...
                        <button
                          ...
                          className="px-4 py-1.5 bg-[#4648d4] hover:bg-[#6063ee] text-white text-xs font-bold rounded-lg shadow-sm flex items-center gap-1"
                        >
                          Resume Lesson
