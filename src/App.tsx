...
export default function App() {
  ...
  const screenLabels: { id: ScreenType; label: string; icon: string }[] = [
    ...
    { id: 'classroom', label: '3. Classroom', icon: 'school' },
    { id: 'question', label: '4. Quiz', icon: 'quiz' },
    { id: 'adaptive', label: '5. Adaptive', icon: 'psychology' },
    { id: 'results', label: '6. Progress', icon: 'leaderboard' },
    { id: 'path', label: '7. Path', icon: 'alt_route' },
  ];
  ...
  return (
    <div className={`min-h-screen w-full flex flex-col font-sans transition-colors duration-200 ${
      ...
      <main className="flex-1 flex flex-col">
        ...
        {currentScreen === 'personalize' && <PersonalizeScreen onNavigate={setCurrentScreen} />}
        {currentScreen === 'classroom' && <ClassroomScreen onNavigate={setCurrentScreen} />}
